...
~~~text title="libEmulatorDetector.so — 대응 전"
...
~~~cmake title="CMakeLists.txt — 시도 1"
...
~~~cmake title="CMakeLists.txt — 시도 2"
# NDK r27 이상
...
~~~bat title="build.bat" hl_lines="7"
...
~~~text title="libEmulatorDetector.so — 대응 후"
